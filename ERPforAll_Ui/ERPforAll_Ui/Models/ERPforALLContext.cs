...
{
    public partial class ERPforALLContext : DbContext
    {
        public ERPforALLContext()
        {
        }

        public ERPforALLContext(DbContextOptions<ERPforALLContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=localhost;Database=ERPforALL;Trusted_Connection=True;");
            }
        }
